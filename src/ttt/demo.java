...
private JLabel lblPnumber;	// 考え得るパターン数
private JLabel lblPnumber_1;
private JLabel lblForS;
...
public demo() {
  ...
  contentPane.setLayout(null);
	...
	lblForS = new JLabel("First");
	lblForS.setFont(new Font("Tahoma", Font.BOLD, 17));
	lblForS.setHorizontalAlignment(SwingConstants.RIGHT);
	lblForS.setBounds(326, 15, 76, 30);
	contentPane.add(lblForS);
	...
	lblPnumber_1 = new JLabel("Pattern:");
	lblPnumber_1.setFont(new Font("Tahoma", Font.BOLD, 17));
	lblPnumber_1.setHorizontalAlignment(SwingConstants.RIGHT);
	lblPnumber_1.setBounds(226, 114, 76, 30);
	contentPane.add(lblPnumber_1);

	lblPnumber = new JLabel("");
	lblPnumber.setFont(new Font("Tahoma", Font.BOLD, 17));
	lblPnumber.setBounds(314, 114, 169, 30);
	contentPane.add(lblPnumber);

	btnReset = new JButton("Reset");
	btnReset.setBounds(226, 157, 76, 23);
	...
	btnCvC.setBounds(324, 157, 169, 23);
...
public void actionPerformed(ActionEvent e) {
	...
	if (e.getSource() == btnNewGame) {
		...
		if (p % 2 == 1) {
			lblForS.setText("Second");
			lblForS.setBounds(331, 15, 76, 30);
			ComputerMove(-1, Color.RED, FirstMove);
			playerStatus = 1;
		} else{
			lblForS.setText("First");
			lblForS.setBounds(326, 15, 76, 30);
			playerStatus = -1;
		}
		p++;
